...
const withAdminAuthorization = (WrappedComponent: React.FC) => {
  return () => {
    const navigate = useNavigate();
    const [authorisationData, setAuthorisationData] = useState<any>({
      authorised: false,
      name: '',
    ...
    if (!authorisationData?.authorised || authorisationData.role !=='admin') {
      return (
