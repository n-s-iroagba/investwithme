    ...
    <Container>
      <Row className="flex-column-reverse flex-lg-row">
        ...
        <Col sm={12} lg={6} className="order-lg-1">
          <h2 style={{textAlign:'center',paddingLeft:'0',marginLeft:'0',paddingTop:'1cm',fontWeight:'950'}}>Your money is safe</h2>
          <h2 style={{textAlign:'center',paddingLeft:'0',marginLeft:'0',fontWeight:'950'}}>with us</h2>
