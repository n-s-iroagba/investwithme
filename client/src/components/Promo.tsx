...
const Promo: React.FC = () => {
  ...
  return (
    <div className='px-4'>
      ...
      <h5 className='mb-4'>If you invest before the timer runs out your return of investment will be increased by a factor no matter the investement tier of manager you choose. So you make extra profits</h5>
      <h6>
